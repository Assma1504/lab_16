...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.from_value.setPlaceholderText("From")
        ...
        self.to_value.setPlaceholderText("To")
        self.convert_btn = QtWidgets.QPushButton(self.frameTop, clicked = lambda : self.press_btn("7"))
        self.convert_btn.setGeometry(QtCore.QRect(10, 145, 100, 50))
        ...
        self.button_c = QtWidgets.QPushButton(self.frameButtom, clicked = lambda : self.press_btn("C"))
